...
if ( $_SERVER['REQUEST_METHOD'] === 'POST' ) {
	...
	$mail->send();
	success( [
		'alert' => sprintf( 'Ακολούθησε το σύνδεσμο που εστάλη στη διεύθυνση %s σου για να ολοκληρώσεις την εγγραφή σου. Έλεγξε και την ανεπιθύμητη αλληλογραφία.', $user->email_address ),
		'location' => site_href(),
	] );
}
